Feature: debug mode
    ...
    Scenario: Single test excecution
        Given a file named "test.js" with:
            ...
            ---*/
            """
        When I run "php bin/harness --debug test.js test.js test.js test.js"
        Then I should see:
            """
    ...
    Scenario: One error
        ...
        And a file named "error.js" with:
            ...
            ---*/
            """
        When I run "php bin/harness --debug test.js test.js error.js test.js test.js"
        Then I should see:
            """
    ...
    Scenario: One failure
        ...
        And a file named "fail.js" with:
            ...
            ---*/
            """
        When I run "php bin/harness --debug test.js test.js fail.js test.js test.js"
