Feature: stop on
    In order to stop the execution of a test suite
    As a user
    ...
    Scenario: Stops on first occuring defect starting with an error
        When I run "php bin/harness --no-cache --concurrency 1 --stop-on-defect empty.js error.js fail.js empty.js"
        Then I should see:
            """
    ...
    Scenario: Stops on first occuring defect starting with a failure
        When I run "php bin/harness --no-cache --concurrency 1 --stop-on-defect empty.js fail.js error.js empty.js"
        Then I should see:
            """
    ...
    Scenario: Stops on first occuring error
        When I run "php bin/harness --no-cache --concurrency 1 --stop-on-error empty.js fail.js error.js empty.js"
        Then I should see:
            """
    ...
    Scenario: Stops on first occuring failure
        When I run "php bin/harness --no-cache --concurrency 1 --stop-on-failure empty.js error.js fail.js empty.js"
        Then I should see:
            """
